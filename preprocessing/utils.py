...
to_drop_values = {
    ...
    "5" : ["DCG EMA", "No hecho"],
    "6" : ["Helicobacter pylori en el momento de la biopsia", "Desconocido"], 
    "7" : ["Fecha nacimiento", "Desconocido"],
    "8" : ["DCG_ATG2", "No hecho"], 
    "9": ["DCG A-PDG", "No hecho"], 
    "10": ["DSG ATG2", "No hecho"], 
    "11": ["DSG A-PDG", "No hecho"], 
    "12": ["Valoracion LIEs DCG", "LIEs no hecho"], 
    "13": ["Valoracion LIEs DSG", "LIEs no hecho"], 
    "14": ["Biopsia DCG", "Sin biopsia hecha"], 
    "15": ["Biopsia DSG", "Sin biopsia hecha"],
    "16": ["DCG_ATG2_VALUE", -1], 
    "17": ["DCG A-PDG_VALUE", -1], 
    "18": ["DSG ATG2 VALUE", -1], 
    "19": ["DSG A-PDG VALUE", -1],
    "20": ["LIEs DCG %GD", -1],
    "21": ["LIEs DCG %iNK", -1],
    "22": ["LIEs DSG %GD", -1], 
    "23": ["LIEs DSG %iNK", -1]    
...
categorical_columns = {
    "0": ["Indique país de origen o en su defecto la información disponible", 
        "Sexo", "Edad diagnóstico", "HLA: grupos de riesgo", "DCG EMA", 
    ...
    "2": ["HLA: grupos de riesgo", "DCG EMA",
        "Helicobacter pylori en el momento de la biopsia", "Fecha nacimiento", 
        "DCG_ATG2", "DCG A-PDG", "DSG ATG2", "DSG A-PDG", "Valoracion LIEs DCG", 
        "Valoracion LIEs DSG", "Biopsia DCG", "Biopsia DSG"],
    "3": ["HLA: grupos de riesgo", "DCG EMA", 
        "Helicobacter pylori en el momento de la biopsia", "Fecha nacimiento", 
        "Biopsia DCG", "Biopsia DSG"],
    ...
    "5": ["Indique país de origen o en su defecto la información disponible", 
        ...
        "Helicobacter pylori en el momento de la biopsia", "Fecha nacimiento", 
        "Biopsia DCG", "Biopsia DSG"],
    "6": ["HLA: grupos de riesgo", "DCG EMA", 
        "Helicobacter pylori en el momento de la biopsia", "Fecha nacimiento", 
        "DCG_ATG2", "DCG A-PDG", "DSG ATG2", "DSG A-PDG", "Valoracion LIEs DCG", 
        "Valoracion LIEs DSG", "Biopsia DCG", "Biopsia DSG"],
    "7": ["HLA: grupos de riesgo", "DCG EMA", 
        "Helicobacter pylori en el momento de la biopsia", "Fecha nacimiento", 
        "Biopsia DCG", "Biopsia DSG"],
